<div align="center">
    <div>
      <img src="https://github.com/itsmartashub/deepstyled/blob/master/assets/deepstyled-assets-header.png" alt="logo-for-deepstyled-chrome-extension"  />
    </div>
</div>
...
<div align="center">
    <div>
      <img src="https://github.com/itsmartashub/deepstyled/blob/master/assets/deepstyled-dark.png" alt="" width="100%"  />
    </div>
</div>
...
<div align="center">
    ...
    <div>
      <div>
        <img src="https://github.com/itsmartashub/deepstyled/blob/master/assets/deepstyled-oled.png" alt="" width="100%"  />
      </div>
        </br>
      <div>
...
1. Download the `deepstyled-firefox-mv2-vX.X.X.zip` from the [Releases](https://github.com/itsmartashub/DeepStyled/releases) and unzip.
2. Open Firefox, go to `about:debugging`
3. Enable `Add-on debugging` in `This Firefox`
4. Click `Load Temporary Add-on` and select `manifest.json` in `deepstyled-firefox-mv2-vX.X.X` folder.
